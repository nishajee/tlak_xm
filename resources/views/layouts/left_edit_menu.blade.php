 ...
 @if(isset($disableDeparture))
  ...
  <li class="kt-nav__item active">
    ...
    <a class="kt-nav__link not-active0" href="{{route('createTour')}}">
            <span class="kt-nav__link-text">1. Basic Details</span>
        </a>
    <li class="kt-nav__item">
      
      <a class="kt-nav__link not-active">
    ...
    <li class="kt-nav__item">
      ...
      <a class="kt-nav__link not-active1" >
    ...
    <li class="kt-nav__item">
      ...
      <a class="kt-nav__link not-active2">
    ...
    <li class="kt-nav__item">
      ...
      <a class="kt-nav__link not-active3">
    ...
    <li class="kt-nav__item">
      ...
      <a class="kt-nav__link not-active4" >
            <span class="kt-nav__link-text">6. Flight Info</span>
        </a>
      
    </li>
    <li class="kt-nav__item">
        <a class="kt-nav__link not-active5">
    ...
    <li class="kt-nav__item">
        <a class="kt-nav__link not-active9 rrmenu">
            <span class="kt-nav__link-text">8. Terms & Conditions</span>
        </a>
    </li>
    ...
    <li class="kt-nav__item">
    <a class="kt-nav__link not-active6">
    ...
    <li class="kt-nav__item">
        ...
        <a class="kt-nav__link not-active7">
